...
\KOMAoptions{paper=a4, fontsize=12pt, chapterprefix=true, twoside=false, DIV=classic, parskip=half, captions=besidetop} % Later change twoside back to semi after inserting the book cover
\linespread{1.25}
...
\renewcommand{\thepage}{Cover Page}
